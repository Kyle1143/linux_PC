...
__attribute__((section("__versions"))) = {
	...
	{ 0x35764e5d, __VMLINUX_SYMBOL_STR(snd_timer_global_new) },
	...
	{ 0x6310cce0, __VMLINUX_SYMBOL_STR(snd_timer_global_register) },
	{ 0x59eb982d, __VMLINUX_SYMBOL_STR(hrtimer_try_to_cancel) },
	{ 0x16c760f3, __VMLINUX_SYMBOL_STR(snd_timer_global_free) },
};
